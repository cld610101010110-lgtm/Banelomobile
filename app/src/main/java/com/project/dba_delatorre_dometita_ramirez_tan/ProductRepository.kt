...
class ProductRepository(
    ...
    suspend fun insertSalesReport(sale: Entity_SalesReport) {
        withContext(Dispatchers.IO) {
            try {
                Log.d(tag, "━━━━━━━━━━━━━━━━━━━━━━━━")
                Log.d(tag, "💰 Saving sale to API...")
                Log.d(tag, "Product: ${sale.productName}")
                Log.d(tag, "Quantity: ${sale.quantity}")
                Log.d(tag, "Price: ₱${sale.price}")

                // Save to Room first
                daoSalesReport.insertSale(sale)
                Log.d(tag, "✅ Sale saved to Room")
                Log.d(tag, "━━━━━━━━━━━━━━━━━━━━━━━━")

            } catch (e: Exception) {
                Log.e(tag, "━━━━━━━━━━━━━━━━━━━━━━━━")
                Log.e(tag, "❌ Failed to save sale!")
                Log.e(tag, "Error: ${e.message}", e)
                Log.e(tag, "━━━━━━━━━━━━━━━━━━━━━━━━")
            }
        }
